...
<body>
    ...
    @php
        ...
        $destnations =shipmentsController::getDestinations('1');
        $activeDest = shipmentsController::getActiveDest('1');
        $dateFrom = date('Y-m-d');
        $dateTo = date('Y-m-d');
        ...
        if (isset($_GET['showBy'])) {
            switch ($_GET['showBy']) {
                case 'range':
                    $shipments =shipmentsController::getShipmentsRange('1',$_GET['from'],$_GET['to']);
                    $dateFrom = date('Y-m-d',strtotime($_GET['from']));
                    $dateTo = date('Y-m-d',strtotime($_GET['to']));
                    break;
                case 'all':
                    $shipments =shipmentsController::getShipments('1');
                    break;
            }
        }else{
            $shipments =shipmentsController::getShipments('1');
            ...
            <div class="row border-top border-bottom py-2">
                <div class="col-md-3 sol-sm-12">
                    <h4 class="main-title">
                        ...
                        @lang('lang.AirFTapTitle') / Cargos ({{count($shipments)}})
                    </h4>
                </div>
            ...
            <div class="modal-body">
                <form action="{{url('/addShipment')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @csrf
                        <input type="hidden" name="shType" value="1">
